            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  ...
                  className={`flex items-center p-3 text-white dark:text-white-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 ${location === '/quiz' ? 'bg-gray-100 dark:bg-gray-700' : ''}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
